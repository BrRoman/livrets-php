...
\JourLiturgique{Saint Martin, évêque}{Fête}
...
\Image{martin}{Saint Martin,\par légionnaire et catéchumène,\par partage son manteau avec un pauvre.\par La nuit suivante,\par le Christ lui apparaîtra en songe\par revêtu de ce même manteau.}
...
\PrefaceWithName{Préface des Pasteurs}{pasteurs}{Martíni}{Martin}
...
\JourLiturgique{XXXII\textsuperscript{e} Dimanche\par du Temps Ordinaire}{}
...
\Image{benigne}{Saint Bénigne,\par Apôtre de la Bourgogne\par et saint Patron du diocèse de Dijon.}

\section{Lundi 13 novembre 2017}

\JourLiturgique{Saint Bénigne, martyr}{Fête}
...
\PrefaceWithName{Préface des Martyrs}{martyrs}{beáti Mártyris Benígni}{saint Bénigne}
...
\JourLiturgique{Mardi de la\par XXXII\textsuperscript{e} semaine\par du Temps Ordinaire}{}
...
\JourLiturgique{Saint Albert le Grand,\par évêque et Docteur de l'Église}{Mémoire mineure}
