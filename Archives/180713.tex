...
\section{Samedi 14 juillet 2018}

\JourLiturgique{Sainte Marie, Reine et Mère de miséricorde}{Mémoire majeure}

\TitreB{Antienne d'introït~:}\Normal{\textit{Salve sancta Parens} (p. 207).}

\TitreB{Ouverture de la célébration~:}\Normal{p. 7.}

\Tierce{laeva_ejus}{17}

\TitreB{Kyrie X}\Normal{(p. 110)}

\Oraison{Oraison}{1}{bmv_39}

\Lecture{Première lecture}{pa_14_6_1_2}

\TitreB{Alleluia~:}\Normal{\textit{Post partum} (p. 210).}

\Lecture{Évangile}{pa_14_6_ev}

\TitreB{Antienne d'offertoire~:}\Normal{\textit{Ave Maria} (p. 183).}

\Oraison{Prière sur les offrandes}{2}{bmv_39}
...
\Oraison{Prière après la Communion}{3}{bmv_39}
...
\section{Dimanche 15 juillet 2018}

\JourLiturgique{XV\textsuperscript{e} dimanche\par du Temps Ordinaire}{}

\TitreB{Antienne d'introït~:}\Normal{\textit{Dum clamarem} (p. 496).}
...
\TitreB{Gloria IV* (ambrosien)}\Normal{(p. 158)}

\TitreB{Oraison~:}\Normal{p. 498.}

\Lecture{Première lecture}{pa_15_0_B_1}

\TitreB{Graduel~:}\Normal{\textit{Ostende nobis} (p. 499).}

\Lecture{Deuxième lecture}{pa_15_0_B_2}

\TitreB{Alleluia~:}\Normal{\textit{Te decet hymnus} (p. 500).}

\Lecture{Évangile}{pa_15_0_B_ev}

\TitreB{Credo I}\Normal{(p. 134).}

\TitreB{Antienne d'offertoire~:}\Normal{\textit{Ad te Domine} (p. 167).}

\TitreB{Prière sur les offrandes~:}\Normal{p. 502.}

\TitreB{Préface des dimanches ordinaires VI~:}\Normal{p. 62}
...
\TitreB{Antienne de communion~:}\Normal{\textit{Passer invenit sibi domum} (p. 502).}

\TitreB{Prière après la communion~:}\Normal{p. 503.}
...
\section{Lundi 16 juillet 2018}

\JourLiturgique{Notre-Dame du Mont-Carmel}{Mémoire mineure}
...
\Lecture{Première lecture}{pa_15_1_1_2}

\TitreB{Graduel~:}\Normal{\textit{Benedicta et venerabilis} (p. 651).}

\Lecture{Évangile}{pa_15_1_ev}

\TitreB{Antienne d'offertoire~:}\par
\Partoche{GR/of_422_5}

\TitreB{Prière sur les offrandes~:}\Normal{p. 502.}

\Preface{Préface commune III}{com_3}
...
\Image{nd_mont_carmel}

%--------------------

\newpage

\section{Mardi 17 juillet 2018}

\JourLiturgique{Mardi de la\par XV\textsuperscript{e} semaine\par du Temps Ordinaire}{}
...
\Lecture{Première lecture}{pa_15_2_1_2}

\TitreB{Alleluia~:}\Normal{\textit{Te decet hymnus} (p. 500).}

\Lecture{Évangile}{pa_15_2_ev}
...
\section{Mercredi 18 juillet 2018}

\JourLiturgique{Mercredi de la\par XV\textsuperscript{e} semaine\par du Temps Ordinaire}{}

\TitreB{Antienne d'introït~:}\Normal{\textit{Ego autem cum justitia} (p. 497).}
...
\Lecture{Première lecture}{pa_15_3_1_2}

\TitreB{Alleluia~:}\Normal{\textit{Te decet hymnus} (p. 500).}

\Lecture{Évangile}{pa_15_3_ev}
...
\TitreB{Antienne de communion~:}\Normal{\textit{Qui manducat} (p. 423).}
