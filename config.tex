...
\newpage
\thispagestyle{empty}
\newgeometry{inner=0cm, outer=0cm, tmargin=7cm}
\begin{center}
\parbox[t]{14.85cm}{\centering\includegraphics[width=12cm]{\FolderData/Images/#1.jpg}\vspace{1cm}}
    \parbox{11cm}{\centering{\itshape{\input{\FolderData/Images/#1.tex}}}}
\end{center}
\restoregeometry}
