...
% Saint du jour (saint, rang) :
\newenvironment{Saint}[2]
{
\begin{flushright}
...
% Préfaces avec nom propre (texte, chemin, nom latin au génitif, nom français) :
\newenvironment{PrefaceNom}[4]
{
\TitreB{#1~:}
...
\begin{center}
\parbox[t]{14.85cm}{\centering\includegraphics[width=8cm]{./Data/Images/#1.jpg}\vspace{0cm}}
