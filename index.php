                ...
                <div id="output">
                    <?php
                        ...
                        for($i = 0; $i < 5; $i++){
                            ...
                            $code = $code."<td class='grid_elem'><div id='grid_label_".$i."'>".$tab_grid[9]."</div><select id='tierce_page_".$i."'><option value='2'>2</option><option value='4'>4</option><option value='6'>6</option><option value='9'>9</option><option value='12'>12</option><option value='15'>15</option><option value='17'>17</option></select></td>";
                            $code = $code."</tr>";
                            $code = $code."</table>";
                            print($code);}
                    ?>
